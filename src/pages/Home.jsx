...
export const Home = () => {
  ...
  const updateFavorites = (candidate) => {
    ...
    let firstLetterCandidates = candidates[nameFirstLetter];
    let newCandidatesArray = firstLetterCandidates.map(flCandidate => flCandidate.uuid == candidate.uuid ? candidate : flCandidate);
